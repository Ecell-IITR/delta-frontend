...
export default class post extends Component {
  render() {
    return (
      <div className="post">
          <div className="leftc">
            <div className="heading"><div className="square" />Internship</div>
            <div className="heading"><div className="square" />Project</div>
            <div className="heading"><div className="square" />Competition</div>
          </div>
          ...
          <form onSubmit={this.handleSubmit}>
              ...
              <div className="c1">
                <div className="jobpos">
                  <span class="fieldTitle">Job Position<br />
                    <input type="text" className="positionField" />
                  </span>
                </div>
                <div className="workloc">
                  <span class="fieldTitle">Location of Work<br />
              ...
              <div className="c6">
                ...
                <input type="text" className="detailsField" /><br />
              </div>
